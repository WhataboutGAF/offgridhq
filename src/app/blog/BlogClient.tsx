        ...
        {posts.map((post, index) => (
          ...
          >
            <Link href={`/blog/${post.slug}`} className="group/post relative">
              <article className="h-full bg-card border-[3.5px] border-foreground rounded-[2rem] overflow-hidden transition-all duration-500 hover:-translate-x-2 hover:-translate-y-2 hover:shadow-[12px_12px_0_0_#4FA4D7] flex flex-col cursor-pointer group-hover/post:bg-secondary/5">
                ...
                <div className="relative h-56 w-full overflow-hidden border-b-[3.5px] border-foreground">
                  ...
                  />
                  <div className="absolute top-4 left-4 bg-primary text-primary-foreground px-4 py-1 rounded-full text-[10px] font-black uppercase tracking-widest shadow-[4px_4px_0_0_#000]">
                    {post.category}
                  </div>
                </div>
